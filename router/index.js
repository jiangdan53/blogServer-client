    ...
    children: [
      {
        name:'blogClass',
        path:'/blogClass',
        component:()=>import('@/views/blogClass/index'),
        meta:{
          title: '文章总类', icon: 'el-icon-suitcase', auth: true 
        }
      },
      {
        name:'typeNav',
        path:'/typeNav',
        component:()=>import('@/views/typeNav/index'),
        meta:{
          title: '总类列表', icon: 'el-icon-receiving', auth: true 
        }
      },
      {
        path: '/blogType',
